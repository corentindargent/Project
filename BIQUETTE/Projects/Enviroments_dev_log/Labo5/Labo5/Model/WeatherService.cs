...
namespace Labo5.Model
{
    public class WeatherService
    {
        public async Task<IEnumerable<WeatherForecast>> GetForecast()
        {
            ...
            var weather = await wc.GetStringAsync(new Uri("http://api.openweathermap.org/data/2.5/forecast/city?q=Namur,BE&lang=fr&units=metric&mode=JSON&APPID=6e613b9aa651996dab54a5fdf5a5b309"));
